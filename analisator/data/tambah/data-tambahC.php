...
$id = $_GET['id'];
?>                      
                        <form action="index.php?page=data-tambahC-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2"><input type="text" id="rumsa" name="rumsa" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">b) Puskesmas/Pustu</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="puskes" name="puskes" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">c) Gudang Farmasi</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="far" name="far" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2"><input type="text" id="r_ringan" name="r_ringan" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">b) Berat</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="r_berat" name="r_berat" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2"><input type="text" id="sumur" name="sumur" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">b) Sumur Tercemar</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="sumur_t" name="sumur_t" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">c) PMA</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="pma" name="pma" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>
                            
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">d) PMA yang Rusak</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="pma_r" name="pma_r" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">Buah</label>
                          </div>

...
$id = $_GET['id'];
?>                      
                        <form action="index.php?page=data-tambahK-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                          ...
                          <div class="row form-group">
                            <div class="col-12 col-md-9"><textarea name="rencana" id="rencana" rows="9" placeholder="..." class="form-control"></textarea></div>
                          </div>
                          </div>
                          </div>

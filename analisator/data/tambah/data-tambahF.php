...
$id = $_GET['id'];
?>                      
                        <form action="index.php?page=data-tambahF-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2"><input type="text" id="j_poskes" name="j_poskes" placeholder="Buah" class="form-control"></div><label for="text-input" class=" form-control-label">buah</label>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2"><input type="text" id="t_poskes" name="t_poskes" placeholder="Orang" class="form-control"></div><label for="text-input" class=" form-control-label">orang</label>
                          </div>
                          ...
                          <div class="row form-group">
                            <div class="col-12 col-md-9"><textarea name="lainnya" id="lainnya" rows="9" placeholder="..." class="form-control"></textarea></div>
                          </div>

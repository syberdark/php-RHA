<div class="breadcrumbs">
        ...
        <div class="col-lg-12">
                        ...
                        <form action="index.php?page=data-tambahA-notif" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3"><input type="text" id="id" name="id" placeholder="ID" class="form-control"></div>
                          </div>
                          </div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3"><input type="text" id="jenis" name="jenis" placeholder="Jenis" class="form-control"></div>
                          </div>
                          </div>
                          </div>
                          </div>

...
$id = $_GET['id'];
?>                      
                        <form action="index.php?page=data-tambahG-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                          ...
                          <div class="row form-group">
                            <div class="col-12 col-md-9"><textarea name="klb" id="klb" rows="9" placeholder="..." class="form-control"></textarea></div>
                          </div>
                          </div>
                          </div>

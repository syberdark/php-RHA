    ...
    $user = $_SESSION['nama'];
      ...
      if(empty($jenis))
      {
        ?>
                  ...
                  <form action="index.php?page=data-editA" method="post" enctype="multipart/form-data" class="form-horizontal">    
          ...
          else
          {
            ...
            if($num > 0)
            {
            ...
            else
              {
                  ...
                  <form action="index.php?page=data-editB&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    

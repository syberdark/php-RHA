...
<?php
if (isset($_GET['id']) AND isset($_POST['bantuan']))
{
    include "../koneksi.php";
  ...
  if(empty($bantuan))
  {
    ?>
                ...
                <div class="alert  alert-warning alert-dismissible fade show" role="alert">
                  <span class="badge badge-pill badge-warning">Warning!</span> Data Bantuan Segera yang Diperlukan Harus Diisi.
                ...
                <form action="index.php?page=data-editJ&id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    
        ...
        else
        {
          $query = "SELECT * FROM dataa WHERE id= '$id'";
            ...
            else
            {
                ...
                $query = "INSERT INTO dataj (id,bantuan,user) VALUES ('$id','$bantuan','$user')";
            }
                ...
                <form action="index.php?page=data-editK&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    

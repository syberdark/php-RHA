...
if (isset($_GET['id']) AND isset($_POST['obat']) AND isset($_POST['kaporit']) AND isset($_POST['pac']) AND isset($_POST['aquatab']) AND isset($_POST['p2pm']))
{
  ...
  if(empty($obat))
  {
    ?>
                ...
                <form action="index.php?page=data-editH&id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    
          ...
          else
          {
            if(empty($p2pm))
            {
              ?>
                        ...
                        <div class="col-sm-12">
                        <div class="alert  alert-warning alert-dismissible fade show" role="alert">
                          <span class="badge badge-pill badge-warning">Warning!</span> Data Keadaan Logistik Program P2P-M Harus Diisi.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
        ...
        else
        {
          $query = "SELECT * FROM dataa WHERE id= '$id'";
            ...
            else
            {
                ...
                <form action="index.php?page=data-editI&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    

...
if (isset($_GET['id']) AND isset($_POST['tim_p']) AND isset($_POST['j_poskes']) AND isset($_POST['t_poskes']) AND isset($_POST['lainnya']))
{
  ...
  if(empty($tim_p))
  {
    ?>
                ...
                <form action="index.php?page=data-tambahF&id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    
    ...
    else
      {
        if(empty($t_poskes))
        {
          ?>
                    ...
                    <div class="col-sm-12">
                    <div class="alert  alert-warning alert-dismissible fade show" role="alert">
                      <span class="badge badge-pill badge-warning">Warning!</span> Data Jumlah Tenaga di POSKES Harus Diisi.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        else
        {
                ...
                <form action="index.php?page=data-tambahG&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    

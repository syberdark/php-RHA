...
if (isset($_GET['id']) AND isset($_POST['k_bencana']))
{
  ...
  if(empty($k_bencana))
  {
    ?>
                ...
                <form action="index.php?page=data-tambahI&id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    
        ...
        else
        {
                ...
                <form action="index.php?page=data-tambahJ&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    

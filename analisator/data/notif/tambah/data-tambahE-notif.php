...
if (isset($_GET['id']) AND isset($_POST['jenis_p']) AND isset($_POST['kapasitas_p']) AND isset($_POST['kapasitas_a']) AND isset($_POST['mck']) AND isset($_POST['t_pembuangan']) AND isset($_POST['spal']))
{
  ...
  if(empty($jenis_p))
  {
    ?>
                ...
                <form action="index.php?page=data-tambahE&id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    
    ...
    if(empty($kapasitas_p))
    {
    ...
    else
      {
        ...
        else
        {
                ...
                <form action="index.php?page=data-tambahF&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    

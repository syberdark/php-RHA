...
include "../koneksi.php";
$id = $_GET['id'];
$sql = "SELECT * FROM dataj WHERE id= '$id'";
$q = mysqli_query($db,$sql);
$row = mysqli_fetch_array($q,MYSQLI_ASSOC);
?>                      
                        <form action="index.php?page=data-editJ-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                          ...
                          <div class="row form-group">
                            <div class="col-12 col-md-9"><textarea name="bantuan" id="bantuan" rows="9" placeholder="..." class="form-control"><?php echo $row['bantuan']; ?></textarea></div>
                          </div>
                          </div>

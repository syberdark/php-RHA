...
include "../koneksi.php";
$id = $_GET['id'];
$sql = "SELECT * FROM datag WHERE id= '$id'";
$q = mysqli_query($db,$sql);
$row = mysqli_fetch_array($q,MYSQLI_ASSOC);
?>                      
                        <form action="index.php?page=data-editG-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                            <div class="card-header">
                              <strong>G. Kemungkinan</strong> KLB yang Akan Terjadi
                            </div>
                          <div class="card-body card-block">

                          <div class="row form-group">
                            <div class="col-12 col-md-9"><textarea name="klb" id="klb" rows="9" placeholder="..." class="form-control"><?php echo $row['klb']; ?></textarea></div>
                          </div>
                          </div>

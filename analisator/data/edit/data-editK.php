...
include "../koneksi.php";
$id = $_GET['id'];
$sql = "SELECT * FROM datak WHERE id= '$id'";
$q = mysqli_query($db,$sql);
$row = mysqli_fetch_array($q,MYSQLI_ASSOC);
?>                      
                        <form action="index.php?page=data-editK-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                            <div class="card-header">
                              <strong>K. Rencana</strong> Tindak Lanjut
                            </div>
                          <div class="card-body card-block">

                          <div class="row form-group">
                            <div class="col-12 col-md-9"><textarea name="rencana" id="rencana" rows="9" placeholder="..." class="form-control"><?php echo $row['rencana']; ?></textarea></div>
                          </div>
                          </div>

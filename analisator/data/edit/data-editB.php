...
?>                          
                        ...
                        <form action="index.php?page=data-editB-notif&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="card">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><input type="text" id="desa" name="desa" placeholder="Desa/Kelurahan" class="form-control" value="<?php echo $row['desa']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kecamatan</label></div>
                            <div class="col-12 col-md-5"><input type="text" id="kecamatan" name="kecamatan" placeholder="Kecamatan" class="form-control" value="<?php echo $row['kecamatan']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kab/Kota</label></div>
                            <div class="col-12 col-md-5"><input type="text" id="kabupaten" name="kabupaten" placeholder="Kab/Kota" class="form-control" value="<?php echo $row['kabupaten']; ?>"></div>
                          </div>  
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3"><input type="date" id="w_mulai" name="w_mulai" placeholder="YYYY-MM-DD" class="form-control" value="<?php echo $row['w_mulai']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Selesai</label></div>
                            <div class="col-12 col-md-3"><input type="date" id="w_selesai" name="w_selesai" placeholder="YYYY-MM-DD" class="form-control" value="<?php echo $row['w_selesai']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jenis Daerah Bencana</label></div>
                            <div class="col-12 col-md-5"><input type="text" id="j_daerah" name="j_daerah" placeholder="Jenis Daerah" class="form-control" value="<?php echo $row['j_daerah']; ?>"></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2"><input type="text" id="t_air" name="t_air" placeholder="Meter" class="form-control" value="<?php echo $row['t_air']; ?>"></div><label for="text-input" class=" form-control-label">Meter</label>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Lama Tergenang</label></div>
                            <div class="col-12 col-md-2"><input type="text" id="lama_t" name="lama_t" placeholder="Jam" class="form-control" value="<?php echo $row['lama_t']; ?>"></div><label for="text-input" class=" form-control-label">Jam</label>
                          </div>
